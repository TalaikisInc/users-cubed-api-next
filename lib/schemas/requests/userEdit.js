...
function defineUserEdit () {
  var enc = [
    encodings.string
  ]

  UserEdit.encodingLength = encodingLength
  UserEdit.encode = encode
  UserEdit.decode = decode
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.dialCode)) {
      var len = enc[0].encodingLength(obj.dialCode)
      length += 1 + len
    }
  ...
  function encode (obj, buf, offset) {
    ...
    if (defined(obj.dialCode)) {
      buf[offset++] = 34
      enc[0].encode(obj.dialCode, buf, offset)
      offset += enc[0].encode.bytes
    }
    if (defined(obj.phone)) {
      buf[offset++] = 42
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        break
        case 4:
        obj.dialCode = enc[0].decode(buf, offset)
        offset += enc[0].decode.bytes
        break
        case 5:
